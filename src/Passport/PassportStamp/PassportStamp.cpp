...
void PassportStamp::onMouseClick() {
   ...
   {
      if (game->getDebug())
         std::cout << "HERE -> Approve Passport clicked" << std::endl;

      is_visible = false;
      if (passport != nullptr)
      {
         passport->setPassportStamp(PassportStampValue::APPROVE);
         passport->setPassportStamped();
   ...
   {
      if (game->getDebug())
         std::cout << "HERE -> Deny Passport clicked" << std::endl;
...
bool PassportStamp::setupTextures() {
   ...
   {
      std::cerr << "Error loading button background" << std::endl;
      return false;
   }
   ...
   {
      std::cerr << "Error loading plank texture 2" << std::endl;
      return false;
   }
   ...
   {
      std::cerr << "Error loading plank texture 3" << std::endl;
      return false;
   }
...
void PassportStamp::setPositions() {
   // Background
...
void PassportStamp::setupActiveAreas() {
